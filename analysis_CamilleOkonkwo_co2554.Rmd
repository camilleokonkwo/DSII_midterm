...
boxplot_recovery =
  ...
  labs(title = "Distribution of Recovery Time Study Group",
       x = "Study Group", y = "Recovery Time") +
  theme_minimal() +
  scale_x_continuous(
...
print(boxplot_recovery)

# recovery_time histogram
histogram_recovery =
  dat |> 
  ggplot(aes(x = recovery_time)) +
  geom_histogram(bins = 150, fill = "skyblue", color = "skyblue") +
  geom_vline(xintercept = c(outlier_low, outlier_high),
             color = "red", linetype = "dashed", size = .5) +
  labs(title = "Distribution of Days to Recovery post COVID-19 Infection with Outliers Highlighted",
       x = "Recovery Time", y = "Frequency") +
  theme_minimal() +
  scale_x_continuous(
    breaks = seq(0, 400, by = 20),  
    labels = seq(0, 400, by = 20)   
...
print(histogram_recovery)

combined_recovery =
  plot_grid(histogram_recovery, boxplot_recovery, labels = c("Histogram", "Boxplot"), ncol = 1)
...
corrplot(cor(x.dat2[, -c(2,3,4,5,6,7,11,12,15,16,17)]), type = "full", diag= FALSE)
```
