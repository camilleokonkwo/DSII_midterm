...
dat_ds <- dat |> 
  ...
  mutate(
    ...
    `Vaccination status at the time of infection` = factor(Vaccine, levels = c(0, 1), labels = c("Not vaccinated", "Vaccinated")),
    `Severity of COVID-19 infection` = factor(Severity, levels = c(0, 1), labels = c("Not severe", "Severe")),
